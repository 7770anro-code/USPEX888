...
- **Авторолик** — до 6 фото друзей + согласие → Grok пишет 4–8 сцен UKRAINIAN CORE. FACE (крупный план конкретного друга) идёт в **Kling 3.0 elements** (`@ElementN` в сценарии, в API всегда `@Element1` на одно фото). WIDE (дрон над городом, колонна в тумане, решётка фар, силуэты в контровом) — **Seedance**, лицо не главное, камеры больше. Сначала подтверждаешь/правишь сценарий в чате, потом съёмка. Голос — Сара или уже сохранённый клон.
